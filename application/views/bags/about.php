				...
				<div class="about-content py-lg-5 py-3">
					<div class="row">
						...
						<div class="col-lg-6 about-info">
							<!--<img src="<?php /*echo base_url();*/?>/assets/images/banner1.jpg" alt="Goggles" class="img-fluid">-->
                            <h3 class="tittle-w3layouts text-left mb-lg-5 mb-3">About Us</h3>
                            <p class="my-xl-4 my-lg-3 my-md-4 my-3">ASP PROMOS was established in 2010 and is your best source for Bags, Towels, Aprons,
                            ...
                            <p>
                                Having Our own in house Printing press gives us the edge to provide Excellent Prices and quick service.
                            </p>

                            <p>
                                Our relations extend to factories in China, India, Pakistan, Bangladesh. We have our own quality
                                team
                                & system to ensure quality products & on time delivery.
                            </p>
                            <a href="" class="btn btn-sm animated-button gibson-three mt-4">Shop Now</a>
						</div>
						<div class="col-lg-6 about-info">
							<h3 class="tittle-w3layouts text-left mb-lg-5 mb-3">Our Services</h3>
                            <p>We Proudly announce to be the largest source for canvas tote bags, aprons and Towels in the industry.
							</p>
                            <p>
                                We have millions of pieces of different products in stock in our warehouse at all times.
                            </p>

                            <p>
                                We offer blank merchandise and can also embellish for you at a very competitive price.
                            </p>
                            <p>
                                We offer screen printing, embroidery, heat transfer, digital printing and much more with proof that its in
                                house.
                            </p>
                            <p>
                                We do offer 24 hours production time or less on rush orders.
                                Quality, Consistency, lowest Price & On Time Delivery is our trademark.
